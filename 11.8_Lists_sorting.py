# 11.8
# 11.8.1
# Пузырьковая сортировка (bubble) вариант 1.
...
for i in range(n - 1):
    for j in range(n - 1):
        if a[j] > a[j + 1]:  # Если порядок элементов пары неправильный.
            a[j], a[j + 1] = a[j + 1], a[j]  # Если порядок элементов пары неправильный.

print('Отсортированный список:', a)

# Пузырьковая сортировка (bubble) вариант 2.
a = [1, 7, -3, 9, 0, -67, 34, 12, 45, 1000, 6, 8, -2, 99]
n = len(a)
...
# Пузырьковая сортировка (bubble) вариант 3.
